...
public class MainActivity extends AppCompatActivity {
    ...
    int iTemp=0,iIn=0,iOut=0,hTemp=0,hIn=0,hOut=0,jIn=0,kIn=12,jOut=0,kOut=12,iIndex=0,hInChange=1,hOutChange=1,ibar=34,jbar=0,t=0;
    float result;
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      ////////////////---------air condition----------------
        ...
        barChart.setNoDataText("Smart Air");
        //--------------------------------------------------
